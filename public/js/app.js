...
Vue.component('upload-video', {
  ...
  methods: {
    ...
    resetProgress: function resetProgress(video) {
      this.progress[video.name] = 0;
      this.$forceUpdate();
      alert("Upload Failed of video {".concat(video.name, "}"));
    }
  }
});
...
module.exports = __webpack_require__(/*! /var/www/html/small-video-uploader/resources/js/app.js */"./resources/js/app.js");
